            ...
            while self.euclidean_distance(local_goal) >= distance_tolerance:
                ...
                if  collision_index_2 and threshold_distance_2 <=3:
                    ...
                    if journal_code_1_orientation.right(r1_ang[0], r2_ang[0]) == True:
                        ...
                        give_way = search.aStarSearch(current_maze, 1, current_state_of_robot, 2, collison_point, neighbour_robot, positions_after_collision)
                        ...
                        head_on_path= search.aStarSearch(current_maze, 1, current_state_of_robot, 3, collison_point, neighbour_robot, positions_after_collision)
